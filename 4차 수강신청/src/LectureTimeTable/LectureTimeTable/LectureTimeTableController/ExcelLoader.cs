        ...
        public void LoadExcelFile()
        {
            ...
            try
            {
                ...
                for (int i = 1; i < 185; i++)
                {
                    ...
                    totalStorage.totalLecture.Add(new Lecture(id, major, courseNumber, classNumber, lectureTitle, completeType, grade, credit, dateAndTime, lectureRoom, professor, language));
                }
